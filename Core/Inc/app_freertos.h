...
typedef enum
{
  ...
  APP_BUTTON_JOY_UPLEFT = 9U,
  APP_BUTTON_JOY_UPRIGHT = 10U,
  APP_BUTTON_JOY_DOWNLEFT = 11U,
  APP_BUTTON_JOY_DOWNRIGHT = 12U,
  APP_BUTTON_COUNT = 13U
} app_button_id_t;
...
#define APP_SYS_EVENT_PERF_MODE   (1UL << 10U)
#define APP_DISPLAY_CMD_TOGGLE    (1UL)
#define APP_DISPLAY_CMD_RENDER_DEMO (2UL)
#define APP_DISPLAY_CMD_INVALIDATE (3UL)
#define APP_SENSOR_REQ_JOY_CAL_NEUTRAL (1UL << 0U)
#define APP_SENSOR_REQ_JOY_CAL_EXTENTS (1UL << 1U)
#define APP_SENSOR_REQ_JOY_CAL_SAVE    (1UL << 2U)
#define APP_SENSOR_REQ_JOY_MENU_ON     (1UL << 3U)
#define APP_SENSOR_REQ_JOY_MENU_OFF    (1UL << 4U)
#define APP_SENSOR_REQ_JOY_MONITOR_ON  (1UL << 5U)
...
#define APP_SENSOR_REQ_POWER_STATS_ON       (1UL << 15U)
#define APP_SENSOR_REQ_POWER_STATS_OFF      (1UL << 16U)
#define APP_SENSOR_REQ_LVCO_TICK            (1UL << 17U)
#define APP_SENSOR_REQ_LIS2_ON              (1UL << 18U)
#define APP_SENSOR_REQ_LIS2_OFF             (1UL << 19U)
